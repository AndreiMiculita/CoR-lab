...
int main(int argc, char** argv)
{
    ...
    results  << "system configuration:" 
            ...
            << "\n\t-object_representation_method = " << "ESF" //TODO: can be a param
        ...
        while (list_of_test_data.good ())// read categories address
        {
            ...
            for (size_t i = 0; i < list_of_object_category.size(); i++) // retrieves all categories from perceptual memory
            {
                ...
                {    
                    ...
                    // jeffreys distance
                    //jeffreysBasedObjectCategoryDistance( object_representation, category_instances, min_distance_object_category, best_matched_index, pp);
