...
typedef pcl::PointXYZRGBA PointT;
 ...
 /* _________________________________
  ...
  int total_number_of_experiments = 5;

  std::string name_of_approach = "Context_Change_JIRS";
...
// 	
	...
	ROS_INFO ("\t\t[-] JIRS generate a random number without srand = %i", random );
// 	string pakage_name = "race_simulated_user";
// 	string file_name= "context_change_idx.txt";
// 	write_a_number_to_file ( pakage_name, file_name, random);
