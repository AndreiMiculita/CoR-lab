...
typedef pcl::PointXYZRGBA PointT;
 ...
 /* _________________________________
  ...
  double ALC = 14.4; //average number of learned categories (ALC)
  ...
  std::string name_of_approach = "Context_Change_LDA";
...
int main(int argc, char** argv)
{
    ...
    ROS_INFO("Hello world: context_change LDA");
...
//     {
	...
	int number_of_categories_in_dataset = number_of_categories;
...
// 	ROS_INFO ("\t\t[-] LDA - Read random number = %i", random );
