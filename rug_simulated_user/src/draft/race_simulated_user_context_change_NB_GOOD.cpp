...
typedef pcl::PointXYZRGBA PointT;
 ...
 /* _________________________________
  ...
  double spin_image_support_lenght = 0.05;
  ...
  double ALC = 31.00; //average number of learned categories (ALC)
  int overlap_between_contexts =0; 
  int total_number_of_experiments = 10;
  std::string name_of_approach = "_thesis_Context_Change_NB_BoW";
...
// 	return 0;
	...
	/// context change index  [0.65ALC, 0.85ALC]
...
// 	
	...
	ROS_INFO ("\t\t[-] **************************************** - Read random number = %i", random );
