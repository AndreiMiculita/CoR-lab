...
typedef pcl::PointXYZRGBA PointT;
 ...
 /* _________________________________
  ...
  //dataset
  std::string home_address = "/media/E2480872480847AD/washington/";	//  IEETA: 	"/home/hamidreza/";
  ...
  std::string name_of_approach = "AAAI2017";
...
void evaluationfunction(const race_perception_msgs::RRTOV &result)
{
	...
	updateGOODNaiveBayesModel(True_cat,cat_id, pp);
...
//     {
	...
	systemStringCommand= "rm -r "+ ros::package::getPath("race_naive_bayes_object_recognition")+ "/NaiveBayesModels" ;
...
// 			      subsample_spinimages);
// 	*/
	introduceNewCategoryGOODAndUpdatingNaiveBayesModel( home_address, 
...
// 				  subsample_spinimages) == -1)
	    ...
	    if ( introduceNewCategoryGOODAndUpdatingNaiveBayesModel( home_address, 
								      class_index,track_id,instance_number2.at(class_index-1),evaluationFile,
								      adaptive_support_lenght,
								      global_image_width,
								      threshold,
