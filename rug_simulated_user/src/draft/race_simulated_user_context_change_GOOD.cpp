...
typedef pcl::PointXYZRGBA PointT;
 ...
 /* _________________________________
  ...
  double ALC = 39; //average number of learned categories (ALC)
...
// 	ros::Publisher pub = nh.advertise< race_perception_msgs::PCTOV> (pcin_topic, 1000);
	...
	ros::Publisher pub_GOOD_representation = nh.advertise<race_perception_msgs::CompleteRTOV> (topic, 100);
...
// 	
	...
	ROS_INFO ("\t\t[-] GOOD - Read random number = %i", random );
...
// 		    
			...
			compuet_object_description( PCDFile,
						    adaptive_support_lenght,
						    global_image_width,
						    threshold,
						    number_of_bins,
